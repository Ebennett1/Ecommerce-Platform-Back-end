...
from .views import RegisterView, UserDetailView, CategoryList, ProductList, ProductDetail, CartDetail, AddToCart, UpdateCartItem, OrderCreate, OrderHistoryView, ClearOrderHistoryView
